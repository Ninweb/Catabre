<?php
    ...
    function crearPedido($json,$db){
        ...
        $sql = "INSERT INTO pedido VALUES (NULL,'$pedido->idCliente', '$pedido->idContenedor','$pedido->codigo_pedido','$pedido->naviera','$pedido->destino','$pedido->fechaSalida','$pedido->fechaLlegada')";
